...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def registerInitialState(self, state):
        ...
        while(currentState.getFood().count() > 0):
            nextPathSegment, hits = self.findPathToClosestDot(currentState) # The missing piece
    ...
    def findPathToClosestDot(self, gameState):
        ...
        # queue.push((startState, self.numHits, []))
        # visited.append((startState, self.num))

        # while True:
        #     currentState, hitWalls, currentActions = queue.pop()
        #     if hitWalls > 2:
        #         continue
        #     if currentState in food  and hitWalls >= 1 and hitWalls <= 2:
        #         if not returnHit:
