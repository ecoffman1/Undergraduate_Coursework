    ...
    def train(self, num_episodes=None, render_env=None):
        ...
        for ep in range(num_episodes):
            ...
            while not done and steps < self.max_steps:
                ...
                #introduce negative reward to prevent agent from falling
                ...
                if not terminated:
                    row = self.q_table[new_state]
                    best_next_action = max(row)
                    td_target = true_reward + self.gamma * best_next_action
                else:
                    td_target = true_reward
